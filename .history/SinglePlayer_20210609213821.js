...
const SinglePlayer = () => {
  ...
  const [IsPressed,setIsPressed]=useState(0);
    ...
    <View style={{ flexDirection:'row'}}>
      ...
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num2===2 ? <Image source={require('./assets/X.jpg')}/> :{}}
      </View>
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
    ...
    { Num4===0 ? <Image source={require('./assets/X.jpg')}/> :{}}
      ...
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num6===0 ? <Image source={require('./assets/X.jpg')}/> :{}}
      </View>
    </View>
    <View style={{ flexDirection:'row'}}>
    <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
    { Num7===0 ? <Image source={require('./assets/X.jpg')}/> :{}}
      </View>
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num8===0 ? <Image source={require('./assets/X.jpg')}/> :{}}
      </View>
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num9===0 ? <Image source={require('./assets/X.jpg')}/> :{}}
      </View>
    </View>
