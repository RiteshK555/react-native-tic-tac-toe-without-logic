...
const SinglePlayer = () => {
    ...
    <View>
      ...
      <View style={{width: 20, height: DeviceWidth*0.2, backgroundColor: 'yellow'}} />
    </View>
    <View>
      <View style={{width: 20, height: DeviceWidth*0.2, marginBottom:1, marginLeft:1, backgroundColor: 'powderblue'}} />
      <View style={{width: 20, height: DeviceWidth*0.2, marginBottom:1, marginLeft:1, backgroundColor: 'skyblue'}} />
      <View style={{width: 20, height: DeviceWidth*0.2, marginLeft:1, backgroundColor: 'yellow'}} />
    </View>
    <View>
      <View style={{width: 20, height: DeviceWidth*0.2, marginBottom:1, marginLeft:1, backgroundColor: 'powderblue'}} />
