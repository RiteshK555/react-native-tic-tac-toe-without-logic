...
const SinglePlayer = () => {
    ...
    <View style={{ flexDirection:'row'}}>
      <View style={{width: 50, height: 50, marginBottom:1, backgroundColor: 'powderblue',borderWidth:1,borderColor:'black'}} />
      <View style={{width: 50, height: 50, marginBottom:1, backgroundColor: 'skyblue',borderWidth:1,borderColor:'black'}} />
      <View style={{width: 50, height: 50, marginBottom:1, backgroundColor: 'yellow',borderWidth:1,borderColor:'black'}} />
    </View>
    <View style={{ flexDirection:'row'}}>
    ...
    <View style={{ flexDirection:'row'}}>
      <View style={{width: 50, height: 20, marginBottom:1, marginLeft:1, backgroundColor: 'powderblue',borderWidth:1,borderColor:'black'}} />
