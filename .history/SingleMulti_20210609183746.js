...
const SingleMulti = ({SingleNavigation, MultiNavigation}) => {
             ...
             <View style={{flexDirection:'row'}}>
                 <View style={SingleMultiStyle.Button1}>
                     <Button title="Single Player Mode" onPress={()=>{
                       MultiNavigation.navigate('Gaming_Screen_SinglePlayer')
                     }}/>
                 </View>
                 <View style={SingleMultiStyle.Button2}>
                    <Button title="Multi Player Mode" onPress={()=>{
                       SingleNavigation.navigate('Gaming_Screen_MultiPlayer')
                    }}/>
                 </View>
             </View>
        </View>
