...
const SinglePlayer = () => {
  ...
  const [IsPressed,setIsPressed]=useState(0);
    ...
    <View style={{ flexDirection:'row'}}>
      ...
      { Num1===1 && <Image source={require(req)}/> }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num2===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num3===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
    </View>
    <View style={{ flexDirection:'row'}}>
    <Pressable
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num4===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num5===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num6===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
    </View>
    <View style={{ flexDirection:'row'}}>
    <Pressable
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num7===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num8===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
      <Pressable
      onPress={()=>{
      ...
      >
      <View style={{justifyContent:'center',alignItems: 'center',width: 50, height: 50, marginBottom:1,marginLeft:1,  backgroundColor: 'white',borderWidth:1,borderColor:'black'}} >
      { Num9===1 && <Image source={require(req)}/>  }
      </View>
      </Pressable>
    </View>
